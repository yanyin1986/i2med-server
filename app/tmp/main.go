...
import (
	...
	_ "i2med-server/app"
	controllers "i2med-server/app/controllers"
	_ "i2med-server/app/models"
	tests "i2med-server/tests"
)
...
func main() {
	...
	revel.RegisterController((*controllers.FriendController)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "AddFriend",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers.MessageController)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "CreateMessage",
				Args: []*revel.MethodArg{ 
